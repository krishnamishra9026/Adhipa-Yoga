...
<div class="card">
    ...
    <div class="card-body">                
                <form class="needs-validation clearfix" method="POST" action="{{route('admin.gallery.update',$gallery)}}" enctype="multipart/form-data">
                    @csrf
                        {{ method_field('PUT') }}
                    <div class="form-row">
                        <div class="col-md-6">
...
<!-- purify.min.js is only needed if you wish to purify HTML content in your preview for 
    ...
    {caption: "{{$gallery->image}}", url: "{{route('admin.gallery-image-delete',$gallery)}}", key: {{$gallery->id}} }
    ],
    @endif
});
    </script>
